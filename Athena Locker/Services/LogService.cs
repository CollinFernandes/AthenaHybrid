...
namespace Athena_Locker.Services
{
    public static class LogService
    {
        ...
        {
            AllocConsole();
            Console.Title = $"Athena Custom Locker";
...
";
            ...
            _writer.WriteLine("");
            Console.WriteLine("");
            _writer.WriteLine("# Athena Custom Locker Log");
            Console.WriteLine("→ Athena Custom Locker Log");
